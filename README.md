...
![02](docs/iShot_2026-06-27_21.46.59.png)
...
```bash
git clone https://github.com/visduo/soloncode-desktop-community.git
cd soloncode-desktop-community
```
