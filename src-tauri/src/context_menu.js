(() => {
  ...
  window.addEventListener(
    ...
    async (event) => {
      ...
      menu.appendChild(createItem('paste', labels.paste || 'Paste', Boolean(editable), () => pasteClipboard(editable)));
      ...
      if (context.localWorkspace) {
        menu.appendChild(
          createItem('folder', labels.folder || 'Open workspace folder', true, () => sendAction('open-workspace')),
        );
      }
      if (context.developmentMode) {
        menu.appendChild(
          createItem('devtools', labels.devtools || 'Open developer tools', true, () => sendAction('open-devtools')),
        );
      }
