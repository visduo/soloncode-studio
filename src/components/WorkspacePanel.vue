  ...
  <div class="main-panel">
    <div class="workspace-content">
      ...
      <div class="workspace-list">
        <section v-for="group in studio.workspaceGroupsWithEntries.value" :key="group.id" class="workspace-group">
          <div class="workspace-group-header" :data-workspace-group-id="group.id">
            ...
            <div v-if="group.id !== studio.constants.DEFAULT_WORKSPACE_GROUP_ID" class="app-menu-wrap">
              <button class="workspace-group-action" type="button" @click="toggle($event, 'group', { path: group.id })">
              ...
              <Teleport to="body">
                <Transition name="menu">
                  <div
                    ...
                    @click.stop
                  >
                    <button class="app-menu-item" type="button" @click="studio.showWorkspaceGroupDialog(group)">
                      <span class="app-menu-icon"><AppIcon name="rename-workspace" /></span>
                      <span>{{ t('workspace.editGroup') }}</span>
                    </button>
                    <button class="app-menu-item" type="button" @click="studio.requestDeleteWorkspaceGroup(group)">
              ...
              <div class="workspace-actions" @click.stop @dblclick.stop>
                ...
                >
                  ...
                  >
                    <AppIcon
                      :name="
                        studio.stoppingWorkspaceKeys.has(studio.workspaceKey(entry.path)) ? 'loading' : 'stop-workspace'
                      "
                    />
                  </button>
                </template>
                      ...
                      >
                        ...
                        >
                          <span class="app-menu-icon">
                            <AppIcon :name="entry.pinned ? 'unpin-workspace' : 'pin-workspace'" />
                          </span>
                          <span>
