...
watch(
  () => [
    ...
    studio.state.preferences.autoCheckUpdates,
  ],
  () => {
...
function selectAutoCheckUpdates(enabled) {
  preferencesForm.autoCheckUpdates = enabled;
  openPreferencesDropdown.value = null;
}
    ...
    <section v-if="activeSection === 'preferences'" class="settings-content preferences-settings-section">
      <div ref="preferencesSettingsForm" class="preferences-settings-form">
        <div class="terminal-settings-field required-field">
          ...
          >
            ...
            <Transition name="settings-select-menu">
              <div v-if="openPreferencesDropdown === 'locale'" class="settings-select-menu" role="listbox">
                <button
        ...
        <div class="terminal-settings-field required-field">
          ...
          >
            <button
              ...
              @click="openPreferencesDropdown = openPreferencesDropdown === 'theme-style' ? null : 'theme-style'"
            ...
            <Transition name="settings-select-menu">
              <div v-if="openPreferencesDropdown === 'theme-style'" class="settings-select-menu" role="listbox">
                <button
        ...
        <div class="terminal-settings-field required-field">
          ...
          >
            <button
              ...
              @click="openPreferencesDropdown = openPreferencesDropdown === 'theme-mode' ? null : 'theme-mode'"
            ...
            <Transition name="settings-select-menu">
              <div v-if="openPreferencesDropdown === 'theme-mode'" class="settings-select-menu" role="listbox">
                <button
        ...
        <div class="terminal-settings-field required-field">
          ...
          >
            <button
              ...
              @click="openPreferencesDropdown = openPreferencesDropdown === 'run-target' ? null : 'run-target'"
            ...
            <Transition name="settings-select-menu">
              <div v-if="openPreferencesDropdown === 'run-target'" class="settings-select-menu" role="listbox">
                <button
        ...
        <div class="terminal-settings-field required-field">
          ...
          >
            <button
              ...
              @click="openPreferencesDropdown = openPreferencesDropdown === 'notifications' ? null : 'notifications'"
              @keydown.down.prevent="openPreferencesDropdown = 'notifications'"
            >
              <span>{{
                t(preferencesForm.notificationsEnabled ? 'settings.notificationsOn' : 'settings.notificationsOff')
              }}</span>
              <span class="settings-select-chevron" aria-hidden="true"></span>
            </button>
            <Transition name="settings-select-menu">
              <div v-if="openPreferencesDropdown === 'notifications'" class="settings-select-menu" role="listbox">
                <button
                ...
                >
                  <span class="settings-select-check" aria-hidden="true"></span>
                  <span>{{ t(option ? 'settings.notificationsOn' : 'settings.notificationsOff') }}</span>
                </button>
              </div>
            </Transition>
          </div>
        ...
        <div class="terminal-settings-field required-field">
          ...
          <div
            class="settings-select"
            :class="{ open: openPreferencesDropdown === 'auto-check-updates' }"
            @keydown.esc="openPreferencesDropdown = null"
          >
            <button
              class="settings-select-trigger"
              type="button"
              aria-haspopup="listbox"
              :aria-expanded="openPreferencesDropdown === 'auto-check-updates'"
              @click="
                openPreferencesDropdown = openPreferencesDropdown === 'auto-check-updates' ? null : 'auto-check-updates'
              "
              @keydown.down.prevent="openPreferencesDropdown = 'auto-check-updates'"
            >
              <span>{{
                t(preferencesForm.autoCheckUpdates ? 'settings.notificationsOn' : 'settings.notificationsOff')
              }}</span>
              <span class="settings-select-chevron" aria-hidden="true"></span>
            </button>
            <Transition name="settings-select-menu">
              <div v-if="openPreferencesDropdown === 'auto-check-updates'" class="settings-select-menu" role="listbox">
                <button
                  v-for="option in [true, false]"
                  :key="String(option)"
                  class="settings-select-option"
                  :class="{ selected: option === preferencesForm.autoCheckUpdates }"
                  type="button"
                  role="option"
                  :aria-selected="option === preferencesForm.autoCheckUpdates"
                  @click="selectAutoCheckUpdates(option)"
                >
                  <span class="settings-select-check" aria-hidden="true"></span>
                  <span>{{ t(option ? 'settings.notificationsOn' : 'settings.notificationsOff') }}</span>
                </button>
